  ...
  return (
    <SafeAreaView style={styles.safe}>
      <View style={styles.container}>
        ...
        <Text style={styles.subtitle}>Canales disponibles para soporte</Text>

        <InfoCard
          title="Correo"
          description="soporte.tandaapp@gmail.com"
        />
        <TouchableOpacity
          style={styles.button}
          onPress={() =>
            abrirEnlace(
              "mailto:soporte.tandaapp@gmail.com?subject=Soporte%20Tanda-app",
        ...
        <TouchableOpacity
          ...
          onPress={() =>
            abrirEnlace(
              "https://wa.me/525512345678?text=Hola,%20necesito%20ayuda%20con%20Tanda-app",
